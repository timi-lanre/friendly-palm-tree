...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#E5D3BC] overflow-hidden">
      ...
      {/* Floating geometric shapes - inspired by the reference */}
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl text-slate-700 max-w-2xl mx-auto leading-relaxed">
                Access over 14,000 verified contacts from over 27 leading wealth management firms across Canada
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 sm:p-12 border border-white/20">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                ...
                <div>
                  <div className="text-3xl sm:text-4xl font-bold text-slate-900 mb-2">27</div>
                  <div className="text-slate-700 font-medium">Leading Firms</div>
                </div>
                <div>
                  <div className="text-3xl sm:text-4xl font-bold text-slate-900 mb-2">95%</div>
                  <div className="text-slate-700 font-medium">Market Coverage</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="relative z-10 text-center py-8 px-6">
        <p className="text-slate-700/70 text-sm">
          © 2025 Advisor Connect. Connecting financial professionals across Canada.
        </p>
      </footer>
    </div>
  )
